...
<div id="container">
    ...
    <button type="button" class="btn btn-primary btn-lg product" style="padding-top: 1px; padding-right: 1px; padding-bottom: 1px; width: 200px; height: 50px; padding-left: 1px; font-size:15px;
	position:relative;
    top:50%; 
                    ...
                    <div class="modal-body" id="productdetails">
                        <table class="table table-striped">
                            <tr>
                                ...
                                <td><input type="text" id="DeviceID" style="text-transform:uppercase"></input>
                                <td>
                                <td><label><b>Monicker:</b><br></td>
                                <td><input type="text" id="Monicker"></input>
                                <td>
                            </tr>
                            <tr>
                                <td><label><b>PTI2:</b><br></td>
                                <td><input type="text" id="PTI2" style="text-transform:uppercase"></input>
                                <td>
                                <td><label><b>Customer:</b><br></td>
                                <td><input type="text" id="Customer"></input>
                                <td>
                            </tr>
                            <tr>
                                <td><label><b>Device Owner:</b><br></td>
                                <td><input type="text" id="DeviceOwner"></input>
                                <td>
                                <td><label><b>Release Code:</b><br></td>
                                <td><input type="text" id="ReleaseCode" style="text-transform:uppercase"></input>
                                <td>
                            </tr>
                            <tr>
                                <td><label><b>WS Location:</b><br></td>
                                <td><input type="text" id="WSLocation" style="text-transform:uppercase"></input>
                                <td>
                                <td><label><b>FT Location:</b><br></td>
                                <td><input type="text" id="FTLocation" style="text-transform:uppercase"></input>
                                <td>
                            </tr>
                            <tr>
                                <td><label><b>Assembly Location:</b><br></td>
                                <td><input type="text" id="AssemblyLocation" style="text-transform:uppercase"></input>
                                <td>
                                <td><label><b>FAB Location:</b><br></td>
                                <td><input type="text" id="FABLocation" style="text-transform:uppercase"></input>
                                <td>
                            </tr>
                            <tr>
                                <td><label><b>Primary TDE:</b><br></td>
                                <td><input type="text" id="PrimaryTDE"></input>
                                <td>
                                <td><label><b>Program Manager:</b><br></td>
                                <td><input type="text" id="ProgramManager"></input>
                                <td>
                            </tr>
                        </table>
        ...
        <table id="tableAddprod" class="display" cellspacing="0" width="100%">
			...
			?>
                ...
                <tr>
                    ...
                    <td style="width:10%"> <button type="button" class="btn btn-warning btn-xs edit_data"
                            id="<?php echo $ID ;?>"><i class="glyphicon glyphicon-pencil"></i> edit</button> &nbsp
                        <button type="button" class="btn btn-danger btn-xs del" id="<?php echo $ID ;?>"><i
