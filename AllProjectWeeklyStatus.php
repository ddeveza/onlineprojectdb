...
<body>
    <div id='dennis'>
        <div class="modal-header" style="position:relative"><button type="button" class="btn btn-warning "
                id="Saveremarks">Save Remarks</< /button>
        </div>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td witdth=""><?php 
								...
								?></td>
                    <td witdth="" class='projectname' id="<?php echo $ProjectID; ?>"><span class="d-inline-block"
                            tabindex="0" data-placement="bottom" data-toggle="tooltip"
                            title="<?php echo $BusinessCase  ;?>"><strong
                                style="cursor: pointer;"><?php echo $ProjName ; ?> <br>
                                <?php echo "No. of Sites: ".$noofsites ; ?> <br>
                                <?php echo "Handler/Prober: ".$handler ; ?></strong></span></td>
                    ...
                    <td witdth="" class='weeks' id="<?php echo $ProjectID; ?>" style="cursor: pointer;">
                        <?php echo $Workweek  ;?></td>


                    <td witdth=""><?php echo $StatusUpdate;  ?></td>
                    <td witdth="" id="data"><textarea rows="3" cols="20"
                            id="<?php echo $ProjectID ?>"><?php echo $Remarks;  ?></textarea></td>
                ...
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="exampleModalLongTitle" style="">
                            <center>Project Dashboard</center>
                        </h5>
        ...
        <div class="modal fade" id="devdashboardModal" tabindex="-1" role="dialog"
            aria-labelledby="devdashboardModalTitle" aria-hidden="true">

            <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="exampleModalLongTitle" style="">
                            <center>Device Dashboard</center>
                        </h5>
        ...
        <div class="modal fade" id="weeklyUpdateModal" tabindex="-1" role="dialog"
            aria-labelledby="weeklyUpdateModalTitle" aria-hidden="true">

            <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="exampleModalLongTitle">
                            <center>Weekly Update</center>
                        </h5>
        ...
        var table = $('#example').DataTable({
            ...
            initComplete: function() {
                this.api().columns([1, 4]).every(function() {
                    ...
                    var select = $(
                            '<select name="wgtmsr" id="wgtmsr" style="width: 100px !important; min-width: 100px; max-width: 50px;><option value=""></option></select>'
                        )
